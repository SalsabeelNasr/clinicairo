  ...
  return (
    <>
      ...
      {isVisible && (
        <div
          className={cx(
            "pointer-events-none fixed z-[70] whitespace-nowrap rounded-md bg-gray-900 px-2 py-1 text-xs font-medium text-white shadow-lg ",
        ...
        >
          ...
          <div 
            className={cx(
              "absolute size-2 rotate-45 bg-gray-900 ",
