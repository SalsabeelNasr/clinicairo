    ...
    <DrawerPortal>
      <DrawerOverlay>
        <DrawerPrimitives.Content
          ...
          className={cx(
            // base
            "fixed inset-y-0 z-50 flex flex-1 flex-col overflow-y-auto bg-white p-4 shadow-lg focus:outline-none  sm:p-6",
            // position
  ...
  return (
    ...
    >
      ...
      <DrawerPrimitives.Close asChild>
        <Button
          variant="ghost"
          className="aspect-square p-1 hover:bg-gray-100 hover:"
        >
...
const DrawerFooter = ({
  ...
  return (
    <div
      className={cx(
        "flex flex-col-reverse border-t border-gray-200 pt-4 sm:flex-row sm:justify-end sm:gap-2 ",
        className,
      )}
      {...props}
    />
