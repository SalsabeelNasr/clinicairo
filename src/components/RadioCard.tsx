  ...
  return (
    <RadioGroupPrimitives.Item
      ...
      className={cx(
        ...
        "data-[state=checked]:",
        // disabled
        "data-[disabled]:border-gray-100 data-[disabled]:",
        "data-[disabled]:bg-gray-50 data-[disabled]:shadow-none data-[disabled]:",
        focusInput,
        className,
      )}
      {...props}
      ...
      >
        <div
          className={cx(
            ...
            "bg-white",
            // disabled
            "group-data-[disabled]:bg-gray-400 group-data-[disabled]:",
          )}
        />
      </RadioGroupPrimitives.Indicator>
    </div>
