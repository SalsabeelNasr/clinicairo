...
>(({ className, children, ...props }, forwardedRef) => (
  <DropdownMenuPrimitives.SubTrigger
    ...
    className={cx(
      ...
      // focus
      "focus-visible:bg-gray-100 data-[state=open]:bg-gray-100 focus-visible: data-[state=open]:",
      // hover
  ...
  return (
    <div
      className={cx(
        ...
        "text-gray-600 ",
        // disabled
        "group-data-[disabled]/DropdownMenuItem:text-gray-400 group-data-[disabled]/DropdownMenuItem:",
        className,
      )}
      {...props}
    />
