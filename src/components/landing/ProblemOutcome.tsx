        ...
        <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2 lg:gap-16">
          ...
          <div className="relative order-2 lg:order-1">
            <div className="relative aspect-[4/5] overflow-hidden rounded-3xl shadow-2xl">
              ...
              <div className="absolute bottom-6 left-6 right-6 rounded-2xl bg-white/95 backdrop-blur-md p-4 shadow-xl ">
            ...
            <div className="absolute -z-10 -top-6 -left-6 size-32 bg-primary-100 rounded-full blur-3xl " />
            <div className="absolute -z-10 -bottom-6 -right-6 size-32 bg-blue-100 rounded-full blur-3xl " />
          </div>
                ...
                <div className="space-y-4">
                  {solutions.map((text, i) => (
                    <div key={i} className="flex gap-3 items-start group">
                      <div className="flex size-6 shrink-0 items-center justify-center rounded-full bg-emerald-100 text-emerald-600  ">
