    ...
    <section className="bg-gray-50  py-12 sm:py-16 lg:py-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
          {steps.map((step, i) => (
            <div key={i} className="relative group">
              ...
              {i < 2 && (
                <div className="hidden md:block absolute top-8 left-[calc(100%-1rem)] w-8 h-px bg-gray-200 " />
              )}
            </div>
          ))}
        </div>
        ...
        <div className="mt-16 sm:mt-24 relative">
          <div className="relative aspect-[16/7] overflow-hidden rounded-3xl shadow-2xl ring-1 ring-gray-200 ">
            <Image
              src="/landing/pexels-karola-g-7195374.jpg"
              alt={lang === "ar" ? "طبيب يستخدم تبييب ديسك" : "Doctor using CliniCairo"}
              fill
