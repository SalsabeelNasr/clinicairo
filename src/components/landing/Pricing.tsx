      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <div className="mb-8">
                ...
                <div className="mt-4 flex items-baseline gap-1">
                  <span className={`text-4xl font-extrabold tracking-tight ${tier.featured ? "text-white" : "text-gray-900 "}`}>
                    {tier.price}
                  </span>
                  <span className={`text-xs font-semibold ${tier.featured ? "text-primary-100" : "text-gray-500 "}`}>
                    {t.planPeriod}
                  </span>
                </div>
                <p className={`mt-2 text-xs font-medium ${tier.featured ? "text-primary-100" : "text-gray-500 "}`}>
                  {tier.description}
                </p>
              </div>
              ...
              <ul className="mb-8 space-y-4 flex-1">
                {tier.features.map((feature, j) => (
                  <li key={j} className="flex items-start gap-3">
                    ...
                    <span className={`text-sm font-medium ${tier.featured ? "text-white" : "text-gray-700 "}`}>
                      {feature}
                    </span>
                  </li>
                ))}
        ...
        <div className="mt-16 flex flex-col items-center">
          <div className="w-full max-w-3xl">
            <div className="group relative overflow-hidden rounded-xl bg-white/80 p-6 ring-1 ring-gray-200/50 transition-all hover:ring-gray-300/50    sm:p-8">
              <div className="flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
                ...
                <div className="flex flex-wrap items-center gap-3 sm:flex-nowrap">
                  <div className="inline-flex items-center gap-2 rounded-lg bg-gray-50 px-3 py-2 ring-1 ring-gray-200/50  ">
