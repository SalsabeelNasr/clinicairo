...
export function PatientSelector({
  ...
  return (
    <div className="space-y-4">
      ...
      {selectedPatient && (
        <div className="flex items-center justify-between rounded-xl border border-primary-100 bg-primary-50/30 p-2.5  ">
        ...
        <div className="space-y-3">
          ...
          {searchResults.length > 0 ? (
            ...
            searchTerm.length >= 2 && !isSearching && (
              <div className="rounded-xl border border-dashed border-gray-200 p-6 text-center  mt-2">
