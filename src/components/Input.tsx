...
const inputStyles = tv({
  base: [
    ...
    [
      ...
      "file:border-solid file:border-gray-300 file:bg-gray-50 file:text-gray-500 file:hover:bg-gray-100 file: file: file:hover: file:disabled:",
      "file:[border-inline-end-width:1px] file:[margin-inline-end:0.75rem]",
      "file:disabled:bg-gray-100 file:disabled:text-gray-500 file:disabled:",
    ],
    // focus
    focusInput,
    // invalid (optional)
