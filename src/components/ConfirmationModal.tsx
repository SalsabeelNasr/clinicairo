...
export function ConfirmationModal({
  ...
  const getIcon = () => {
    switch (variant) {
      case "danger":
        return <RiCloseLine className="size-6 text-red-600 " />
      case "warning":
        return <RiAlertLine className="size-6 text-yellow-600 " />
      case "success":
        return <RiCheckLine className="size-6 text-green-600 " />
      case "info":
        return <RiInformationLine className="size-6 text-blue-600 " />
    }
  }
