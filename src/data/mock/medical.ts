...
export const mockWeightLogs: WeightLog[] = [
  // Fatima Mohamed (patient-001)
  {
    ...
    notes: "Initial weight at first consultation",
  },
  {
    id: "weight-001-2",
    patient_id: "patient-001",
    weight: 73.5,
    recorded_date: new Date(Date.now() - 105 * 24 * 60 * 60 * 1000).toISOString().split("T")[0],
  ...
  },
  {
    ...
    patient_id: "patient-001",
    weight: 71.2,
    recorded_date: new Date(Date.now() - 75 * 24 * 60 * 60 * 1000).toISOString().split("T")[0],
  ...
  },
  {
    ...
    patient_id: "patient-001",
    weight: 69.5,
    recorded_date: new Date(Date.now() - 45 * 24 * 60 * 60 * 1000).toISOString().split("T")[0],
  ...
  },
  {
    ...
    patient_id: "patient-001",
    weight: 68.8,
    recorded_date: new Date(Date.now() - 15 * 24 * 60 * 60 * 1000).toISOString().split("T")[0],
    notes: "Near target",
  },
  {
    id: "weight-004",
...
export const mockInjections: Injection[] = [
  {
    ...
    dose: "2.5mg",
    injection_date: new Date(Date.now() - 21 * 24 * 60 * 60 * 1000).toISOString().split("T")[0],
    next_suggested_date: new Date(Date.now() - 14 * 24 * 60 * 60 * 1000).toISOString().split("T")[0],
    next_suggested_dose: "2.5mg",
  ...
  },
  {
    ...
    next_suggested_dose: "2.5mg",
    notes: "Second dose. Patient reports decreased appetite.",
    appointment_id: null,
  },
  {
    id: "inj-p1-003",
    ...
    next_suggested_date: new Date(Date.now()).toISOString().split("T")[0],
    next_suggested_dose: "5mg",
    notes: "Third dose. Adhering to diet plan.",
    appointment_id: "apt-029",
  },
  {
    id: "inj-p1-004",
    patient_id: "patient-001",
    ...
    next_suggested_date: new Date(Date.now() + 7 * 24 * 60 * 60 * 1000).toISOString().split("T")[0],
    next_suggested_dose: "5mg",
    notes: "Fourth dose. Escalated to 5mg.",
    appointment_id: null,
  },
  {
    id: "inj-001",
...
export const mockLabResults: LabResult[] = [
  // Fatima Mohamed (patient-001) - Hypertension monitoring
  {
    ...
    patient_id: "patient-001",
    entry_type: "file",
    test_name: "cbc-panel-results.pdf",
    value: "",
    unit: "",
    normal_range: "",
    status: "normal",
    test_date: new Date(Date.now() - 3 * 24 * 60 * 60 * 1000).toISOString().split("T")[0],
    pdf_url: DEMO_LAB_PDF_URL,
    file_name: "cbc-panel-results.pdf",
    file_size: 412_000,
    mime_type: "application/pdf",
    notes: "Full blood count report",
    lab_file_id: null,
  },
  {
    id: "lab-001",
