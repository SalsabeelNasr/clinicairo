  ...
  return (
    <div className="rounded-xl bg-gray-50/50 border border-gray-100 p-3  ">
      <div className="flex items-center gap-3">
        <RiCalendarLine className="size-5 text-primary-600  shrink-0" />
        ...
        <div className="grid gap-3 sm:grid-cols-2">
          {services.map((service) => (
            <button
              ...
              className="group relative rounded-xl border border-gray-100 p-3 text-left transition-all hover:border-primary-200 hover:bg-primary-50/30    shadow-sm"
            >
              ...
              <div className="mt-2 flex items-center justify-between">
                <span className="text-[11px] font-bold text-primary-600  bg-primary-100  px-2 py-0.5 rounded-lg">
            ...
            <div className="mt-2 grid grid-cols-3 gap-2 sm:grid-cols-4">
              {timeSlots.map((slot) => (
                <button
                  ...
                  className="rounded-xl border border-gray-100 bg-white p-2.5 text-center transition-all hover:border-primary-200 hover:bg-primary-50/30   shadow-sm"
                >
