      ...
      {tasks.map((task) => {
        ...
        return (
          <div
            key={task.id}
            className={cx(
              "group relative flex flex-col p-3 transition-colors bg-white  rounded-xl border border-gray-100  hover:border-gray-200  shadow-sm",
              isDone && "opacity-75"
            )}
          >
            {/* Status Accent Line */}
            ...
            <div className="flex flex-wrap items-center justify-between gap-x-3 gap-y-1.5 w-full pb-2 mb-2 ml-1 border-b border-gray-100 ">
                      ...
                      <>
                        ...
                        {canAssign ? (
                          <button
                            ...
                            className="font-medium text-primary-600 hover:text-primary-700   transition-colors underline-offset-2 hover:underline"
                          >
                            {task.assignedToName}
                          </button>
                        ) : (
              ...
              <button
                ...
                className={cx(
                  ...
                  isDone 
                    ...
                    : "bg-gray-50 text-gray-400 hover:bg-green-500 hover:text-white   "
                )}
