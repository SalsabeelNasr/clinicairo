    ...
    <div className="space-y-4">
      ...
      {events.length === 0 ? (
        ...
        <div className="relative space-y-4">
          {/* Vertical line */}
          <div className="absolute left-2.5 top-0 h-full w-px bg-gray-100 " />

          {events.map((event) => (
            <div key={event.id} className="relative pl-8">
              {/* Dot */}
              <div className="absolute left-0 top-1.5 size-5 rounded-full bg-white ring-2 ring-gray-100   flex items-center justify-center">
                <div className={cx(
                  "size-2 rounded-full",
