        ...
        {loading && events.length === 0 ? (
          ...
          <Card>
            <CardContent className="flex flex-col items-center justify-center py-12 text-center">
              ...
              <p className="mt-4 text-gray-600 ">No activity recorded yet.</p>
            </CardContent>
          </Card>
        ) : (
          <>
            <div className="relative">
              {/* Timeline line */}
              <div className="absolute left-4 top-0 h-full w-px bg-gray-200  md:left-6" />
...
function ActivityItem({ event }: { event: ActivityEvent }) {
  ...
  return (
    <div className="relative pl-10 md:pl-14">
      {/* Icon dot */}
      <div className="absolute left-2 top-1 flex size-5 items-center justify-center rounded-full bg-white ring-4 ring-white   md:left-4 md:size-6">
        <div className={cx(
      ...
      <div className="group rounded-xl border border-gray-100 bg-white p-4 shadow-sm transition-all hover:border-gray-200   ">
            ...
            {event.entityLabel && (
              <div className="flex items-center gap-1.5 text-xs font-medium">
                ...
                {link ? (
                  ...
                  <span className="text-gray-700 ">{event.entityLabel}</span>
                )}
              </div>
            )}
          </div>

          <div className="flex items-center gap-1.5 text-xs text-gray-500  sm:shrink-0">
